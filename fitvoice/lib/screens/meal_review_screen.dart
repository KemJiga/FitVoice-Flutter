...
class MealReviewScreen extends StatelessWidget {
  ...
  const MealReviewScreen({super.key, required this.mealReport});
  ...
  Future<List<MealReportCard>> getCards() async {
    return [];
  }
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          var protein = mealReport.foodReports.foodFoundItem.food.protein;
          var carbs = mealReport.foodReports.foodFoundItem.food.carbohydrates;
          var fat = mealReport.foodReports.foodFoundItem.food.fat;
          var calories = mealReport.foodReports.foodFoundItem.food.calories;
